                    ...
                    <n-space vertical>
                        <div class="d-flex flex-column justify-content-end">
                            <n-space vertical>
                                ...
                                <n-button id="getBGBtn" class="w-100"
                                    @click="this.GetGeneratedGradientBackgrounds(amountBG)">Generate
            ...
            <section v-if="generatedGradientBGS.length > 0">
                ...
                <div id="generatedBGContainer">
                    <button @click="setSelectedGradient(item)" v-for="item of generatedGradientBGS" class="gradientBox"
                        :key="item" :style="'background: ' + gradientLayout + '-gradient(' +
                        item.color1 +
                        ',' +
                        item.color2 +
                        ')'"></button>
                ...
                <n-card title="CSS">
                    <template #cover>
                        <div class="resultGradientBox" :style="
                            ...
                            'background: ' + gradientLayout + '-gradient(' +
